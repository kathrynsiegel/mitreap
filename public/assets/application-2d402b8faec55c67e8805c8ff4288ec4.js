...
$(document).ready(function() {
	...
	if (cticap) {
		...
		else if (document.getElementById("Scotland (UK)")) {
			xlabels = ["2000","2001", "2002","2003","2004","2005","2006","2007","2008","2009","2010"];
			ydata = [167, 212, 199, 149, 125, 173, 229, 232, 269, 276, 375];
		}
	...
	if (ctstem) {
		...
		if (document.getElementById("New Zealand")) {
			...
			xlabels = ["2000","2001","2002","2003","2005","2006","2007","2008","2009","2010","2011"];
			ydata = [129497, 154085, 659706, 169198, 150412, 148374, 145529, 146065, 146698, 155414, 168103]; 
		}
	...
	if (ctrd) {
		...
		if (document.getElementById("New Zealand")) {
			...
			xlabels = ["2000","2001", "2002","2003","2004","2005","2006","2007","2008","2009"];
			ydata = [1.38, 1.56, 1.64, 1.56, 1.5, 1.62, 1.44, 1.49, 1.49, 1.67, 1.58, 1.56];
		}
